...
var cardListController = function($controller, $routeParams, $scope, api, log) {
...
cardListController.$inject = ['$controller', '$routeParams', '$scope', 'api', 'log'];
angular.module('boiler').controller('cardListController', cardListController);